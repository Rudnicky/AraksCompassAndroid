...
public class HamburgerMenuDrawable extends Drawable {
    ...
    private int mBackgroundStrokeColor = Color.RED;

    private boolean mMenuMode;
    //endregion

    //region Ctor
    public HamburgerMenuDrawable(int strokeWidth, int lineColor, int backgroundColor, int backgroundStrokeColor){
    ...
    private void setUp(){
        ...
        mBackgroundPaint.setColor(mBackgroundStrokeColor);
